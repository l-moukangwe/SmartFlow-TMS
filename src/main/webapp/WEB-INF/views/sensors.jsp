...
<body>
	...
	<div class="container mt-4">
		<div class="d-flex justify-content-between align-items-center mb-4">
			<h2>
				<i class="fas fa-microchip"></i> Sensors Management
			</h2>
		...
		<div class="card">
			<div class="card-header bg-dark text-white">
				<i class="fas fa-list"></i> Current Sensors
			</div>
			<div class="card-body">
					...
					<tbody>
						<c:forEach items="${sensors}" var="s">
							<tr>
								...
								<td>${s.sensor_type}</td>
								<td><span
									class="badge bg-${s.status == 'Active' ? 'success' : 'secondary'}">${s.status}</span></td>
								<td><a href="/smartflow/sensors/delete?id=${s.sensor_id}"
									class="btn btn-sm btn-danger"
									onclick="return confirm('Delete?')"><i class="fas fa-trash"></i>
										Delete</a></td>
							</tr>
						</c:forEach>
					</tbody>
